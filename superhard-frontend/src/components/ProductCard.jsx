function ProductCard({ img, title, price, oldPrice }) {
  return (
    <div className="bg-[#282828] text-white rounded-2xl shadow-lg p-4 flex flex-col w-64 h-[23rem] hover:scale-105 transition-transform duration-300">
      ...
      {/* Contenedor superior: imagen + título, ocupa todo el espacio disponible */}
      ...
      <div className="flex flex-col gap-2">
        ...
        <button className="bg-green-900 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-xl shadow-md transition-colors w-full">
          Ver Producto
        </button>
      </div>
